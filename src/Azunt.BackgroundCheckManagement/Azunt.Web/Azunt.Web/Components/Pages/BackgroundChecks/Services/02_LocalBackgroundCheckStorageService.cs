...
namespace Azunt.Web.Components.Pages.BackgroundChecks.Services
{
    public class LocalBackgroundCheckStorageService : IBackgroundCheckStorageService
    {
        private readonly string _container = "files";
        private readonly string _subFolder;
        private readonly string _rootPath;
        private readonly ILogger<LocalBackgroundCheckStorageService> _logger;

        public LocalBackgroundCheckStorageService(IWebHostEnvironment env, ILogger<LocalBackgroundCheckStorageService> logger, string subFolder = "backgroundChecks")
        {
            _logger = logger;
        ...
        public Task<Stream> DownloadAsync(string fileName)
        {
            ...
            if (!File.Exists(fullPath))
                throw new FileNotFoundException($"BackgroundCheck not found: {fileName}");
