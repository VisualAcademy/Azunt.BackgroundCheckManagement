...
{
    public class AzureBlobBackgroundCheckStorageService : IBackgroundCheckStorageService
    {
        private readonly BlobContainerClient _containerClient;
        private readonly string _subFolder;

        public AzureBlobBackgroundCheckStorageService(IConfiguration config, string subFolder = "backgroundChecks")
        {
        ...
        public async Task<Stream> DownloadAsync(string fileName)
        {
            ...
            if (!await blobClient.ExistsAsync())
                throw new FileNotFoundException($"BackgroundCheck file not found: {fileName}");
